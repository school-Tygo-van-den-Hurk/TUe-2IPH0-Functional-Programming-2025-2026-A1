...
--   Copyright    : Tygo van den Hurk, 2026
--                  Huub de Beer, 2019, 2020
--                  Tom Verhoeff, 2019
--   License      : None
--
...
--      [Parsec's package page](https://hackage.haskell.org/package/parsec-3.1.14.0/docs/Text-Parsec.html#t:ParseError)
